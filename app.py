...
], style={"display": "flex", "flexDirection": "row", "flexWrap": "wrap", "margin": "0", "padding": "0", "fontFamily": "Segoe UI, Roboto, sans-serif"})
...
def atualizar_cards(cidades, clientes, industrias, anos, meses):
    ...
    return [
        html.Div([html.H4("💰 Vendas"), html.H3(f"R$ {total:,.2f}")], style={"padding": "15px", "backgroundColor": "#ffffff", "borderRadius": "10px", "boxShadow": "0 2px 6px rgba(0,0,0,0.1)", "width": "160px", "minWidth": "45%", "maxWidth": "45%", "margin": "5px auto", "textAlign": "center"}),
        html.Div([html.H4("📦 Pedidos"), html.H3(pedidos)], style={"padding": "15px", "backgroundColor": "#ffffff", "borderRadius": "10px", "boxShadow": "0 2px 6px rgba(0,0,0,0.1)", "width": "160px", "minWidth": "45%", "maxWidth": "45%", "margin": "5px auto", "textAlign": "center"}),
        html.Div([html.H4("👥 Clientes"), html.H3(clientes_ativos)], style={"padding": "15px", "backgroundColor": "#ffffff", "borderRadius": "10px", "boxShadow": "0 2px 6px rgba(0,0,0,0.1)", "width": "160px", "minWidth": "45%", "maxWidth": "45%", "margin": "5px auto", "textAlign": "center"}),
        html.Div([html.H4("🏭 Indústrias"), html.H3(industrias_ativas)], style={"padding": "15px", "backgroundColor": "#ffffff", "borderRadius": "10px", "boxShadow": "0 2px 6px rgba(0,0,0,0.1)", "width": "160px", "minWidth": "45%", "maxWidth": "45%", "margin": "5px auto", "textAlign": "center"})
    ]
...
def atualizar_aba(aba, cidades, clientes, industrias, anos, meses, tipo_centro):
    ...
    if aba == "visao":
        ...
        for _, row in resumo.iterrows():
            ...
            donuts.append(dcc.Graph(figure=fig, style={"width": "100%", "maxWidth": "300px", "margin": "10px auto"}))
